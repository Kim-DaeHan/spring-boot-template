...
public record BookResponseDto(
		@Schema(description = "도서 ID", example = "1") Integer id,

		@Schema(description = "도서 제목", example = "해리포터와 비밀의 방") String title,

		@Schema(description = "저자", example = "J.K. 롤링") String author,

		@Schema(description = "도서 상태", example = "AVAILABLE") BookStatus status,

		@Schema(description = "카테고리 목록") Set<CategoryResponseDto> categories) {
